...
known_wheels = {}
known_wheels[WALZE_I] = (PERM_I, NOTCH_I, "WALZE_I", False)
known_wheels[WALZE_II] = (PERM_II, NOTCH_II, "WALZE_II", False)
known_wheels[WALZE_III] = (PERM_III, NOTCH_III, "WALZE_III", False)
known_wheels[WALZE_IV] = (PERM_IV, NOTCH_IV, "WALZE_IV", False)
known_wheels[WALZE_V] = (PERM_V, NOTCH_V, "WALZE_V", False)
known_wheels[WALZE_VI] = (PERM_VI, NOTCH_VI, "WALZE_VI", False)
known_wheels[WALZE_VII] = (PERM_VII, NOTCH_VII, "WALZE_VII", False)
known_wheels[WALZE_VIII] = (PERM_VIII, NOTCH_VIII, "WALZE_VIII", False)
known_wheels[WALZE_ABW_I] = (PERM_ABW_I, NOTCH_ABW_I, "WALZE_ABW_I", False)
known_wheels[WALZE_ABW_II] = (PERM_ABW_II, NOTCH_ABW_II, "WALZE_ABW_II", False)
known_wheels[WALZE_ABW_III] = (PERM_ABW_III, NOTCH_ABW_III, "WALZE_ABW_III", False)
known_wheels[WALZE_ABW_ETW] = (PERM_ABW_ETW, NOTCH_EMPTY, "WALZE_ABW_ETW", True)
known_wheels[WALZE_RB_I] = (PERM_RB_I, NOTCH_RB_I, "WALZE_RB_I", False)
known_wheels[WALZE_RB_II] = (PERM_RB_II, NOTCH_RB_II, "WALZE_RB_II", False)
known_wheels[WALZE_RB_III] = (PERM_RB_III, NOTCH_RB_III, "WALZE_RB_III", False)
known_wheels[WALZE_RB_ETW] = (PERM_RB_ETW, NOTCH_EMPTY, "WALZE_RB_ETW", True)
known_wheels[WALZE_T_I] = (PERM_T_I, NOTCH_T_I, "WALZE_T_I", False)
known_wheels[WALZE_T_II] = (PERM_T_II, NOTCH_T_II, "WALZE_T_II", False)
known_wheels[WALZE_T_III] = (PERM_T_III, NOTCH_T_III, "WALZE_T_III", False)
known_wheels[WALZE_T_IV] = (PERM_T_IV, NOTCH_T_IV, "WALZE_T_IV", False)
known_wheels[WALZE_T_V] = (PERM_T_V, NOTCH_T_V, "WALZE_T_V", False)
known_wheels[WALZE_T_VI] = (PERM_T_VI, NOTCH_T_VI, "WALZE_T_VI", False)
known_wheels[WALZE_T_VII] = (PERM_T_VII, NOTCH_T_VII, "WALZE_T_VII", False)
known_wheels[WALZE_T_VIII] = (PERM_T_VIII, NOTCH_T_VIII, "WALZE_T_VIII", False)
known_wheels[WALZE_T_ETW] = (PERM_T_ETW, NOTCH_EMPTY, "WALZE_T_ETW", True)
known_wheels[UKW_A] = (PERM_UKW_A, NOTCH_EMPTY, "UKW_A", False)
known_wheels[UKW_B] = (PERM_UKW_B, NOTCH_EMPTY, "UKW_B", False)
known_wheels[UKW_C] = (PERM_UKW_C, NOTCH_EMPTY, "UKW_C", False)
known_wheels[UKW_D] = (PERM_UKW_D, NOTCH_EMPTY, "UKW_D", True)
known_wheels[UKW_B_DN] = (PERM_UKW_B_DN, NOTCH_EMPTY, "UKW_B_DN", False)
known_wheels[UKW_C_DN] = (PERM_UKW_C_DN, NOTCH_EMPTY, "UKW_C_DN", False)
known_wheels[UKW_ABW] = (PERM_ABW_UKW, NOTCH_EMPTY, "UKW_ABW", False)
known_wheels[UKW_RB] = (PERM_RB_UKW, NOTCH_EMPTY, "UKW_RB", False)
known_wheels[UKW_T] = (PERM_T_UKW, NOTCH_EMPTY, "UKW_T", False)
known_wheels[WALZE_BETA] = (PERM_BETA, NOTCH_EMPTY, "WALZE_BETA", False)
known_wheels[WALZE_GAMMA] = (PERM_GAMMA, NOTCH_EMPTY, "WALZE_GAMMA", False)
known_wheels[TYPEX_SP_02390_A] = (PERM_SP_02390_A, NOTCH_SP_02390, "TYPEX_SP_02390_A", False)
known_wheels[TYPEX_SP_02390_B] = (PERM_SP_02390_B, NOTCH_SP_02390, "TYPEX_SP_02390_B", False)
known_wheels[TYPEX_SP_02390_C] = (PERM_SP_02390_C, NOTCH_SP_02390, "TYPEX_SP_02390_C", False)
known_wheels[TYPEX_SP_02390_D] = (PERM_SP_02390_D, NOTCH_SP_02390, "TYPEX_SP_02390_D", False)
known_wheels[TYPEX_SP_02390_E] = (PERM_SP_02390_E, NOTCH_SP_02390, "TYPEX_SP_02390_E", False)
known_wheels[TYPEX_SP_02390_F] = (PERM_SP_02390_F, NOTCH_SP_02390, "TYPEX_SP_02390_F", False)
known_wheels[TYPEX_SP_02390_G] = (PERM_SP_02390_G, NOTCH_SP_02390, "TYPEX_SP_02390_G", False)
known_wheels[TYPEX_ETW] = (PERM_TYPEX_ETW, NOTCH_EMPTY, "TYPEX_ETW", True)
known_wheels[TYPEX_SP_02390_UKW] = (PERM_SP_02390_UKW, NOTCH_EMPTY, "TYPEX_SP_02390_UKW", True)
known_wheels[WALZE_KD_I] = (PERM_KD_I, NOTCH_KD_I, "WALZE_KD_I", False)
known_wheels[WALZE_KD_II] = (PERM_KD_II, NOTCH_KD_II, "WALZE_KD_II", False)
known_wheels[WALZE_KD_III] = (PERM_KD_III, NOTCH_KD_III, "WALZE_KD_III", False)
known_wheels[WALZE_KD_IV] = (PERM_KD_IV, NOTCH_KD_IV, "WALZE_KD_IV", False)
known_wheels[WALZE_KD_V] = (PERM_KD_V, NOTCH_KD_V, "WALZE_KD_V", False)
known_wheels[WALZE_KD_VI] = (PERM_KD_VI, NOTCH_KD_VI, "WALZE_KD_VI", False)
known_wheels[WALZE_KD_ETW] = (PERM_KD_ETW, NOTCH_EMPTY, "WALZE_KD_ETW", True)
known_wheels[TYPEX_Y_269_A] = (PERM_Y_269_A, NOTCH_Y_269, "TYPEX_Y_269_A", False)
known_wheels[TYPEX_Y_269_B] = (PERM_Y_269_B, NOTCH_Y_269, "TYPEX_Y_269_B", False)
known_wheels[TYPEX_Y_269_C] = (PERM_Y_269_C, NOTCH_Y_269, "TYPEX_Y_269_C", False)
known_wheels[TYPEX_Y_269_D] = (PERM_Y_269_D, NOTCH_Y_269, "TYPEX_Y_269_D", False)
known_wheels[TYPEX_Y_269_E] = (PERM_Y_269_E, NOTCH_Y_269, "TYPEX_Y_269_E", False)
known_wheels[TYPEX_Y_269_F] = (PERM_Y_269_F, NOTCH_Y_269, "TYPEX_Y_269_F", False)
known_wheels[TYPEX_Y_269_G] = (PERM_Y_269_G, NOTCH_Y_269, "TYPEX_Y_269_G", False)
known_wheels[TYPEX_Y_269_H] = (PERM_Y_269_H, NOTCH_Y_269, "TYPEX_Y_269_H", False)
known_wheels[TYPEX_Y_269_I] = (PERM_Y_269_I, NOTCH_Y_269, "TYPEX_Y_269_I", False)
known_wheels[TYPEX_Y_269_J] = (PERM_Y_269_J, NOTCH_Y_269, "TYPEX_Y_269_J", False)
known_wheels[TYPEX_Y_269_K] = (PERM_Y_269_K, NOTCH_Y_269, "TYPEX_Y_269_K", False)
known_wheels[TYPEX_Y_269_L] = (PERM_Y_269_L, NOTCH_Y_269, "TYPEX_Y_269_L", False)
known_wheels[TYPEX_Y_269_M] = (PERM_Y_269_M, NOTCH_Y_269, "TYPEX_Y_269_M", False)
known_wheels[TYPEX_Y_269_N] = (PERM_Y_269_N, NOTCH_Y_269, "TYPEX_Y_269_N", False)
known_wheels[TYPEX_Y_269_UKW] = (PERM_Y_269_UKW, NOTCH_EMPTY, "TYPEX_Y_269_UKW", True)
