...
#define KW_ENIG_ROTOR_SELECTION  "rotors"
#define KW_ENIG_RINGSTELLUNG "rings"
#define KW_ENIG_STECKERBRETT "plugs"
#define KW_USES_UHR "usesuhr"
#define KW_UKW_D_PERM "ukwdperm"
