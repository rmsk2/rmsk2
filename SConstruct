...
base_visual_files += ['randomizer_dialog.cpp', 'perm_display_dialog.cpp']
...
rmsk.Install('dist/pyrmsk2', Glob('pyrmsk2/tlvsrvapp.py'))
rmsk.Install('dist/pyrmsk2', Glob('pyrmsk2/msgprocedure.py'))
rmsk.Install('dist/pyrmsk2', Glob('pyrmsk2/indicatorprocessor.py'))
rmsk.Install('dist/pyrmsk2', Glob('pyrmsk2/formatter.py'))
rmsk.Install('dist/pyrmsk2', Glob('pyrmsk2/transportencoder.py'))
